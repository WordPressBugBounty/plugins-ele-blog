...
namespace Elementor;
class Eleblog_Latest_News extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News', 'ele-blog' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Eleblog_Latest_News() );