 ...
 * @since 1.0
 */
class Ele_Blog_Style_Four extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Image Hover Style', 'ele-blog' );
    }
...
plugin::instance()->widgets_manager->register_widget_type(new Ele_Blog_Style_Four());
