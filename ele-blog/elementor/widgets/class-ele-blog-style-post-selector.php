...
namespace Elementor;
class Eleblog_Post_Selector_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Selector', 'ele-blog' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'style-one'   => __( 'Style One', 'ele-blog' ),
					'style-two'   => __( 'Style Two', 'ele-blog' ),
					'style-three' => __( 'Style Three', 'ele-blog' ),
					'style-four'  => __( 'Style Four', 'ele-blog' ),
					'style-five'  => __( 'Style Five', 'ele-blog' ),
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#201654',
				'selectors' => [
					'{{WRAPPER}} .single-post-wrap .details .title a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} a:hover,
					.single-post-wrap.style-overlay .details .title:hover .title a' => 'color: {{VALUE}};',
				],
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Eleblog_Post_Selector_Widget() );