...
class Eleblog_What_Is_New_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'What\'s New', 'ele-blog' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'section_title', [
				...
				'default' => esc_html__( 'What’s new', 'ele-blog' )
			]
		);
		...
		$this->add_control(
			'word_limit', [
				'label'   => esc_html__( 'Word Limit For Content', 'ele-blog' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '40', 'ele-blog' )
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#201654',
				'selectors' => [
					'{{WRAPPER}} .single-post-wrap .details p' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .single-post-wrap .details p',
				'fields_options' => [
					// first mimic the click on Typography edit icon
					'typography'  => [ 'default' => 'yes' ],
					// then redifine the Elementor defaults
...
Plugin::instance()->widgets_manager->register_widget_type( new Eleblog_What_Is_New_Widget() );